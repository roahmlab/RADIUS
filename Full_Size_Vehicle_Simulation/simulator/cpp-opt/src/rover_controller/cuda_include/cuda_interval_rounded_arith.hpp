//
// Header Cuda Interval Rounded Arith Begin
//
...
#ifndef CUDA_INTERVAL_ROUNDED_ARITH_HPP_
#define CUDA_INTERVAL_ROUNDED_ARITH_HPP_
...
//
// Header Cuda Interval Rounded Arith End
//
