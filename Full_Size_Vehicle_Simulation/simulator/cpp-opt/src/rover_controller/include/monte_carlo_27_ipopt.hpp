#ifndef ROAHM_MONTE_CARLO_27_IPOPT_HPP_
#define ROAHM_MONTE_CARLO_27_IPOPT_HPP_
...
class MonteCarlo27IpoptProblem : public Ipopt::TNLP {
private:
  ...
  bool mirror_;
  RiskProblemDescription risk_inputs_;

  void Recompute(const double trajectory_param);

public:
MonteCarlo27IpoptProblem(
  ...
  ~MonteCarlo27IpoptProblem() override = default;
  MonteCarlo27IpoptProblem() = delete;
  MonteCarlo27IpoptProblem(const MonteCarlo27IpoptProblem&) = delete;
  MonteCarlo27IpoptProblem& operator=(const MonteCarlo27IpoptProblem&) = delete;
};
} // namespace roahm::monte_carlo_ipopt
#endif // ROAHM_MONTE_CARLO_27_IPOPT_HPP_