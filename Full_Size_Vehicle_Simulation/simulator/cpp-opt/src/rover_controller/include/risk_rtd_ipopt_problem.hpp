#ifndef ROAHM_RISK_RTD_IPOPT_PROBLEM_HPP_
#define ROAHM_RISK_RTD_IPOPT_PROBLEM_HPP_
#include <vector>
...
class RiskRtdIpoptProblem : public Ipopt::TNLP {
private:
  ...
  ::roahm::risk_constraint::RiskConstraint risk_constraint_;
  ::roahm::risk_constraint::RiskConstraintValues last_risk_constraint_values_;
...
public:
  RiskRtdIpoptProblem(const Vehrs& vehrs,
  ...
  ~RiskRtdIpoptProblem() override = default;
  RiskRtdIpoptProblem() = delete;
  RiskRtdIpoptProblem(const RiskRtdIpoptProblem&) = delete;
  RiskRtdIpoptProblem& operator=(const RiskRtdIpoptProblem&) = delete;
};

} // namespace roahm::risk_rtd_ipopt_problem
#endif // ROAHM_RISK_RTD_IPOPT_PROBLEM_HPP_
